  ...
  return (
    <div className="container mx-auto px-4 py-12 space-y-20">
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-8 pt-10">
        <h1 className="text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-game-accent-blue to-game-accent-purple">
          Orðaskák
        </h1>
      ...
      <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <FeatureCard
            icon={<Brain className="h-12 w-12 text-game-accent-blue" />}
          ...
          <FeatureCard
            icon={<Users className="h-12 w-12 text-game-accent-purple" />}
            title="Spila með Vinum"
            description="Keppaðu við vini þína eða fjölskyldu í skemmtilegum fjölspilaraleik."
          />
          
          <FeatureCard
            icon={<Globe className="h-12 w-12 text-game-accent-pink" />}
